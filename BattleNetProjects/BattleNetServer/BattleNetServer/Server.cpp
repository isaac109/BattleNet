...
void Server::StartChessGames()
{
	...
	while(true)
	{
		...
		if(waiting.size() >= 2)
		{
			...
			serverptr->PlayersStates[0] = GameState::G_In_Chess;
			serverptr->PlayersStates[1] = GameState::G_In_Chess;
			...
			//TODO Figure out how to kill thread safetly
			//serverptr->KillThread[p1] = true;
			//serverptr->ClientThreads[p2] = CreateThread(NULL, NULL, (LPTHREAD_START_ROUTINE)ClientHandlerThread, (LPVOID)(TotalConnections), NULL, NULL);
		}
	}
}
